...
#define VBE_MODE_INFORMATION_FUNC 0x01
#define VBE_FUNCTION_SUCESSFUL 0x00
#define VBE_CONTROLLER_INFORMATION_FUNC 0x00
#define VBE_MODE 0x02
#define FLAT_BUFFER_MODE_BIT BIT(14)
#define MODE_105 0x105
#define CONTROLLER_CAPABILITIES_DAC_BIT BIT(0)
#define CONTROLLER_CAPABILITIES_VGA_BIT BIT(1)
#define CONTROLLER_CAPABILITIES_RAMDAC_BIT BIT(2)
#define VIDEO_MODE_END 0xFFFF
#define MODE_100 0x100
#define MODE_101 0x101
#define MODE_102 0x102
#define MODE_103 0x103
#define MODE_104 0x104
#define MODE_105 0x105
#define MODE_106 0x106
...
typedef struct {
	uint8_t VbeSignature[4];	// "VESA" or "VBE2" - neste caso é  = a VBE2
	uint16_t VbeVersion;
